...
Твоя задача — выбрать:
1. operation_type — один из: "regular", "transfer", "refund", "credit_payment", "investment_buy", "investment_sell", "credit_disbursement".
...
class ClusterHypothesis(BaseModel):
    ...
    operation_type: str = Field(description="regular/transfer/refund/credit_payment/investment_buy/investment_sell/credit_disbursement")
